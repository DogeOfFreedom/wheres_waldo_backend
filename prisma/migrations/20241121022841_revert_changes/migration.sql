/*
  ...
  - You are about to drop the column `location_percents` on the `Level` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "Level" DROP COLUMN "location_percents",
